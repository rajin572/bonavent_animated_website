...
const CircularBadge = () => {
    ...
    return (
        <div className="relative w-40 h-40 flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-[#06243F]/40 backdrop-blur-md rounded-full border border-white/5 shadow-2xl ">
                <div ref={ringRef} className="relative w-full h-full">
                    {text.split("").map((char, i) => {
                        ...
                        return (
                            <span
                                key={i}
                                className="absolute left-1/2 top-1/2 text-sm font-extrabold text-[#c7ea46] drop-shadow-[0_0_8px_rgba(199,234,70,0.5)]"
                                style={{
