...
const HOST_DASHBOARD_URL = "https://host-bonavent.vercel.app/sign-in";
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <div className="qr-code w-25 h-25 bg-gray-50 rounded-xl flex items-center justify-center border border-gray-200 mb-3 p-1.5">
                                <ReactQRCode value="https://car-rental-landing.vercel.app/ios" />
                            </div>
                        ...
                        >
                            ...
                            <div className="qr-code w-25 h-25 bg-gray-50 rounded-xl flex items-center justify-center border border-gray-200 mb-3 p-1.5">
                                <ReactQRCode value="https://car-rental-landing.vercel.app/android" />
                            </div>
                            <p className="text-[10px] font-semibold text-lighter-color tracking-widest uppercase">
                                Scan to download
                            </p>
