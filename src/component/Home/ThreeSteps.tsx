    ...
    return (
        <section ref={sectionRef} className="w-full bg-secondary-color py-20 lg:py-28 relative overflow-hidden">
            ...
            <div aria-hidden className="absolute inset-0 pointer-events-none">
                <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-[700px] h-[350px] rounded-full bg-white/5 blur-3xl" />
                <div className="absolute bottom-0 -left-20 w-[350px] h-[350px] rounded-full bg-white/4 blur-2xl" />
                <div className="absolute bottom-0 -right-20 w-[300px] h-[300px] rounded-full bg-white/4 blur-2xl" />
            </div>
            ...
            <Container>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-stretch relative z-10">
                    ...
                    {/* ── Step 1 — Download & Sign Up (white featured card) ── */}
                    <div className="step-card relative bg-white rounded-3xl p-8 md:p-10 flex flex-col justify-between overflow-hidden shadow-2xl">
                        <span className="step-number absolute -top-6 -right-3 text-[10rem] font-black text-secondary-color/[0.06] leading-none select-none pointer-events-none">
                            01
                        </span>
                    ...
                    <div className="step-card relative bg-white/10 border border-white/20 rounded-3xl p-8 md:p-10 text-white flex flex-col justify-between overflow-hidden">
                        <span className="step-number absolute -top-6 -right-3 text-[10rem] font-black text-white/[0.06] leading-none select-none pointer-events-none">
                            02
                        </span>
